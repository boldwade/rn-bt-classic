 ...
 */
export default class RecycleTestScreen extends React.Component {
    ...
    constructor(args) {
        ...
        let dataProvider = new DataProvider((r1, r2) => {
            console.log('dataProvider', r1, r2);
            return r1 !== r2;
        });
        ...
        this.state = {
            dataProvider: dataProvider.cloneWithRows(this._generateArray(900))
        };
    }
